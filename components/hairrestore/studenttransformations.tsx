...
const StudentTransformations = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      description: "Correct temple recession and restore youthful hairlines with advanced hair transplantation.",
      image: "/images1.png",
      alt: "Baldness treatment results showing hair regrowth",
    },
    {
      title: "Bald Spots Hair Transplant",
      description: "Treat patchy baldness and localized hair loss with targeted graft implantation.",
      image: "/images2.png",
      alt: "Hair thinning treatment showing improved density",
    },
    {
      title: "Thinning Crown Hair Transplant",
      description: "Improve crown density with customized FUE hair transplant procedures.",
      image: "/images3.png",
      alt: "Alopecia treatment showing patch regrowth",
    },
    {
      title: "Advanced Baldness Hair Transplant",
      description: "High graft-count procedures for severe hair loss and scalp coverage restoration.",
      image: "/images4.png",
