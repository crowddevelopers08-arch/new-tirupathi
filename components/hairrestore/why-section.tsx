          ...
          >
            <div className="relative inline-block">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">
                ...
                >
                  Why Choose Advanced Grohair Hair Transplant Clinic?
                  <motion.div 
            ...
            >
              ...
              <div className="w-full lg:w-[30%] grid grid-cols-1 auto-rows-fr gap-3 sm:gap-4 md:gap-6 h-full">
                <BentoFeature
                  ...
                  desc="Our expert hair transplant doctors specialize in advanced baldness hair transplant procedures with precision and natural hairline restoration."
                />
                <BentoFeature
                  title="Advanced FUE Hair Transplant in Tirupati"
                  desc="We offer minimally invasive FUE hair transplant treatments with faster recovery time and natural results."
                />
                <BentoFeature
                  title="FUT Hair Transplant Specialists"
                  desc="Our FUT hair transplant procedures are ideal for patients requiring higher graft counts and maximum density."
                />
              </div>
              ...
              <div className="w-full lg:w-[30%] grid grid-cols-1 auto-rows-fr gap-3 sm:gap-4 md:gap-6 h-full">
                <BentoFeature
                  ...
                  desc="We provide customized hair transplant for women experiencing thinning hair, widening partition, and hairline loss."
                />
                <BentoFeature
                  title="Natural Hairline Hair Transplant"
                  desc="Achieve dense, natural-looking hair growth with scientifically designed hair graft placement."
                />
                <BentoFeature
                  title="Affordable Hair Transplant Cost in Tirupati"
                  desc="Get transparent pricing with flexible payment options and consultation support."
                />
              </div>
            </motion.div>
          </div>
