        ...
        >
          <div className="relative inline-block">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight ">
              ...
              >
                Real Patients. Real Hair Restoration Results.
                <motion.div 
            ...
            <p className="mb-4 max-w-2xl text-base leading-relaxed text-gray-600 sm:text-lg">
              See how our treatments have helped people regain confidence and glow naturally.
            </p>
            </div>
          </div>
        </motion.div>
