          ...
          >
            ...
            {showThankYou ? (
              ...
              <button
                ...
                className={`w-full ${isFormValid ? 'bg-[#d90f12] hover:bg-[#b80d0f]' : 'bg-gray-400'} text-white py-3 rounded-lg font-semibold transition-colors text-sm sm:text-base mt-3 sm:mt-4 disabled:bg-gray-400 disabled:cursor-not-allowed`}
              >
