  ...
  const sections = [
    {
      ...
      description: "Say goodbye to unwanted hair with long-lasting, painless laser solutions for smooth skin.",
      image: "treat.jpg",
      alt: "Hair transplant before and after results",
    },
    {
      title: "Hydrafacial",
      description: "Instant glow with deep cleansing, hydration, and skin rejuvenation — perfect before events!",
      image: "treat1.jpg",
      alt: "Baldness treatment results showing hair regrowth",
    },
    {
      title: "Chemical Peel",
      description: "Reduce acne, pigmentation, and dullness. Reveal brighter, smoother skin underneath.",
      image: "treat2.jpg",
      alt: "Hair thinning treatment showing improved density",
    },
    {
      title: "Face PRP (Vampire Facial)",
      description: "Boost collagen naturally using your own growth factors for youthful, glowing skin.",
      image: "treat3.jpg",
    ...
    },
    {
      ...
      description: "Target stubborn acne, scars, and uneven tone with expert-guided solutions.",
      image: "treat5.jpg",
        ...
        >
          <div className="relative inline-block">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">
              ...
              >
                Regain Confidence with Personalised Skin Treatments
                <motion.div 
